...
# YOUR CODE HERE!
loan_avg = total_loan_amount/total_loans
print(loan_avg)
...
# YOUR CODE HERE!
def pres_value_month(future_value, remaining_months, annual_discount_rate):
...
# YOUR CODE HERE!
present_value = pres_value_month(new_loan.get("future_value"), new_loan.get("remaining_months"), 0.2)
